    ...
    <section className="bg-white">
      <div className="container py-10 mt-20">
        ...
        <form className="mt-3 flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-1">
            <label>What area of design are most proficient in now?</label>
            <select className="self-start border-neutral border-[1px] w-[90%] sm:w-[350px] border-solid rounded-md text-sm  bg-neutral-10 px-2 py-1 md:px-3 focus:outline-none">
              <option className="hover:bg-primary-blue" value="UI Design">
                UI Design
              </option>
              <option className="hover:bg-primary-blue" value="UX Design">
                UX Design
              </option>
              <option className="hover:bg-primary-blue" value="Graphics Design">
                Graphics Design
              </option>
              <option className="hover:bg-primary-blue" value="UX Reasearcher">
                UX Reasearcher
              </option>
