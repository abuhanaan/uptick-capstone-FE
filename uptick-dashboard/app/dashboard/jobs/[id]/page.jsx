...
import { fetchJobApplicants } from 'app/utils/api';
...
const Program = ({ params }) => {
    ...
    const applicants = [
        { id: 1, name: 'Adam', status: 'Accepted', date: '12/12/2022' },
        { id: 2, name: 'Monsur', status: 'Rejected', date: '12/12/2022' },
        { id: 3, name: 'Precious', status: 'Pending', date: '12/12/2022' },
        { id: 4, name: 'Maryam', status: 'Accepted', date: '12/12/2022' },
        { id: 5, name: 'Alice', status: 'Accepted', date: '12/12/2022' },
    ];
    ...
    useEffect(() => {
        const fetchDataFromApi = async () => {
            ...
            if (session.accessToken) {
                const response = await fetchJobApplicants(session.accessToken);
        ...
        <div className='mt-6'>
            ...
            <div className="flex flex-col items-start gap-y-2 lg:flex-row lg:justify-between lg:items-center lg:mb-6">
                <div className="text-2xl breadcrumbs font-bold">
                    <ul>
                        <li className='text-[#C8D7FF]'><Link href='/dashboard/jobs'>Jobs</Link></li>
                        <li className='capitalize'>Applicants</li>
                    </ul>
                </div>
            ...
            <div>
                {
                    data?.length === 0 ?
                        <EmptySearch headers={['Name', 'Status', 'Date']} /> :
