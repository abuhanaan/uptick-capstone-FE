    ...
    <>
        <div className='bg-gray-100 rounded-lg my-10 mx-4 pt-10 pb-5 px-8'>
            ...
            <div className="flex items-start justify-between flex-col xl:flex-row border-[#999999] border py-4 lg:py-7 px-8 lg:px-12 bg-[#EDF2FF] rounded-lg gap-8">
                <img src="/images/kuda-img.png" alt="Company logo" className='rounded-lg flex-none w-full xl:max-w-[241px]' />

                <div className="flex flex-col flex-1 xl:w-2/3">
                    <h3 className='text-lg font-bold mb-[5px]'>Software Engineer (Backend)</h3>
                    ...
                    <h4 className='text-sm font-bold my-4'>Company <span className='font-normal ml-3'>Kuda</span></h4>

                    <h4 className='text-sm font-bold'>Company <span className='font-normal ml-3'>18th Nov. 2023</span></h4>
                </div>
            </div>
        </div>
    </>
...
const FullPreview = () => (
    <div className='flex flex-col mt-12 bg-gray-100 rounded-md px-20 py-6'>
        ...
        <h1 className='text-2xl font-bold mb-4'>Software Engineer (Backend)</h1>

        <div className='flex flex-col lg:flex-row lg:items-center justify-between lg:mb-4 text-sm font-bold'>
            <h4 className='mb-2 lg:mb-0'>Company <span className='font-normal ml-3'>Kuda</span></h4>
            <h4 className='mb-2 lg:mb-0'>Deadline <span className='font-normal ml-3'>18th Nov. 2023</span></h4>
        </div>

        <div className='flex flex-col lg:flex-row lg:items-center justify-between lg:mb-4 text-sm font-bold'>
            <h4 className='mb-2 lg:mb-0'>Job Category <span className='font-normal ml-3'>Software Engineering</span></h4>
            <h4 className='mb-2 lg:mb-0'>Job Type <span className='font-normal ml-3'>Full-time</span></h4>
        </div>

        <div className='flex flex-col lg:flex-row lg:items-center justify-between lg:mb-4 text-sm font-bold'>
            <h4 className='mb-2 lg:mb-0'>Location <span className='font-normal ml-3'>Africa</span></h4>
            <h4 className='mb-2 lg:mb-0'>Work Arrangement <span className='font-normal ml-3'>Remote</span></h4>
        </div>
