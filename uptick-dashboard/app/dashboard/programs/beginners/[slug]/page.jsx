...
const Program = ({ params }) => {
    ...
    const programCategory = 'Talent Beginners';
            ...
            <div className="flex flex-col items-start gap-y-2 lg:flex-row lg:justify-between lg:items-center lg:mb-6">
                <div className="text-2xl breadcrumbs font-bold">
                    <ul>
                        ...
                        <li><Link href={`/dashboard/programs/beginners/${params.slug}`} className='capitalize'>{programTitle === 'ai & data' ? 'AI & Data' : programTitle}</Link></li>
                    </ul>
                </div>
