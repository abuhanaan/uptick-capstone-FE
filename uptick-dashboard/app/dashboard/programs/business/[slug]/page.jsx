...
const Program = ({ params }) => {
    ...
    const programCategory = 'Talent Business';
        ...
        <div className='mt-6'>
            ...
            <div className="flex flex-col items-start gap-y-2 lg:flex-row lg:justify-between lg:items-center lg:mb-6">
                <div className="text-2xl breadcrumbs font-bold">
                    <ul>
                        <li className='text-[#C8D7FF]'><Link href='/dashboard/programs/business'>Talent Business</Link></li>
                        <li><Link href={`/dashboard/programs/business/${params.slug}`} className='capitalize'>{programTitle === 'ai & data' ? 'AI & Data' : programTitle}</Link></li>
                    </ul>
                </div>
